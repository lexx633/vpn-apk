...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/lexx633/vpn-app"
    const val APP_API_URL = "https://api.github.com/repos/lexx633/vpn-app/releases"
    ...
    const val VPN = "VPN"
    // limm VPN: 1280 by default — REALITY+TCP over the ISP path fragments large packets,
    // 1500 made big pages stall (dest_block) while small probes passed. 1280 (IPv6 min MTU)
    // is the safe value that makes browser page loads work end-to-end through the tunnel.
